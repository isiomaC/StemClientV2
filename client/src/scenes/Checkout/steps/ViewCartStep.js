    ...
    return <>
            ...
            <Grid container>
                ...
                <Grid style={{ background: 'rgba(255,255,255,0.7)' }} item xs={4}>
                    ...
                    {similarProducts.map(item => (
                        ...
                        <SimilarProduct id={item.idx} name={item.name} description={item.benefits} size={item.size} price={item.price} image={item.base64} />
                    ))}
                </Grid>
            </Grid>
        )}
        ...
        {isSmall && (
            ...
            <Grid container style={{ marginTop: '20px' }}>
                <Grid item xs={12}>
                    {shoppingcart.items.map((item, index) => <ProductDisplay key={index} cart={item} />
                    )}
                    <br />
                    <br />
                    <br />
